...
**CIA**, **Confidentiality**, **Integrity**, **Availability**, **Hashing**, **Encryption**, **Access Control**, **Identification**, **Authentication**, **Authorization**, **Redundancy**, **SPOF**, **RAID**, **Failover**, **Load Balancer**, **NIC Teaming**, **UPS**, **Elasticity**, **Scalability**, **Resiliency**, **TCO**, **Risk**, **Threat**, **Vulnerability**, **Security Incident**, **Mitigation**, **Control**, **Technical Control**, **Managerial Control**, **Operational Control**, **Physical Control**, **Preventive**, **Detective**, **Corrective**, **Deterrent**, **Compensating**, **Directive**, **NIST**, **SP 800-53**, **Logs**, **Metadata**, **SIEM**, **SEM**, **SIM**, **Packet Capture**, **Syslog**, **NTP**, **UBA**, **Alert Tuning**, **False Positive**, **False Negative**
